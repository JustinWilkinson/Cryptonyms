...
namespace Cryptonyms.Server.Repository
{
    ...
    public class GameRepository : Repository, IGameRepository
    {
        ...
        public async Task SaveGameAsync(Game game)
        {
            ...
            {
                _logger.LogError(ex, "An error occurred saving game '{game.GameId}'.", game.GameId);
                throw;
            }
        }
        ...
        public async Task AddOrUpdatePlayerInGameAsync(string gameId, Player player)
        {
            ...
            {
                _logger.LogError(ex, "An error occurred identifying player '{name}' in game '{gameId}'.", player.Name, gameId);
                throw;
            }
        }
